...
function showNotification(message, type) {
    ...
    notification.style.cssText = `
        ...
        ${type === 'success' ? 'background: linear-gradient(135deg, #00d4ff, #0099cc);' : 'background: linear-gradient(135deg, #ff6b6b, #ee5a52);'}
    `;
...
console.log(`
🚀 Welcome to Mahnoor Irfan's Portfolio!
📧 Contact: mahnoor.irfan@email.com
